...
//////////////Example usage
private var _directoryMonitor:DirectoryMonitor = new DirectoryMonitor();

function init():void
{
    var f:File = new File();
    f.nativePath = "user/documents/project1";

    _directoryMonitor.addDirectory(f);
    _directoryMonitor.addEventListener(DirectoryMonitor_Event, onDirectoryChange)
    _directoryMonitor.watch();
}

private function onDirectoryChange(e:DirectoryMonitor_Event):void
{
    trace("The directory " + e.file.nativePath + " has been changed");
}